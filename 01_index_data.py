...
INDEX_SETTINGS = { "settings":{
                        "analysis": {
                            ...
                            "analyzer": {
                                #"spanish": { "tokenizer":  "standard", "filter":[ "lowercase", "spanish_stop", "spanish_stemmer" ]},
...
NUMBERS = {'primero':1, 'segundo':2, 'tercero':3, 'cuarto':4,
           ...
           'ventiuno':21, 'veintidos':22, 'veintitres':23, 'veinticuatro':24, 'veinticinco':25, 'veintiseis':26, 'veintisiete':27, 'veintiocho':28, 'veintinueve':29, 'treinta':30, 'treinta y uno':31}
